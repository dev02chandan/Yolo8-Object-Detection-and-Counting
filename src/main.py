...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='50 epochs balanced.pt', help="Path to the YOLO model file.")
    parser.add_argument('--classes_to_count', nargs='+', type=int, help="List of class IDs to count.", default=[i for i in range(1, 11)])
