...
from process_livestream import VideoProcessor
import tempfile
import os
import time
import torch
...
if (
    ...
    with st.spinner("Processing..."):
        ...
        if file_type == "video":
            object_counts = process_video_and_count(
                file_path,
                selected_model,
                class_ids,
                run_dir,
            ...
            st.write(f"Object counts: Diamonds = {object_counts}")
